  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h5">{element?.addMatchPrivilege}11</Typography>
        </Box>
        <Box
          sx={{
        ...
        >
          <Typography variant="h5">{element.allPrivilege}22</Typography>
        </Box> */}
        <Box>
        ...
        >
          <Typography variant="h5">{element?.totalComission}33</Typography>
        </Box> */}
        <Box
          sx={{
            width: { lg: "11.5vw", md: "20.5vw", xs: "26.5vw" },
        ...
        >
          <Typography variant="h5">{element?.userBal?.exposure}44</Typography>
        </Box> */}
        <Box
          sx={{
